...
#Plotting:
    ...
    if do_print:
        with open(f'{fname}_stats.txt', 'w') as stats_file:
            for stat, x in avg.items():
                print("using average of time series:", file=stats_file)
                print("stats on {}:".format(stat), file=stats_file)
                print("data: {}".format(x), file=stats_file)
                print("min:", file=stats_file)
                print(np.min(x), file=stats_file)
                print("max:", file=stats_file)
                print(np.max(x), file=stats_file)
                print("std:", file=stats_file)
                print(np.std(x), file=stats_file)
                low, mean, high = confidence_interval(x, confidence=0.95)
                print("mean:", file=stats_file)
                print(mean, file=stats_file)
                print("median:", file=stats_file)
                print(np.median(x), file=stats_file)
                print("95% confidence interval for the mean:", file=stats_file)
                print("({0},{1})".format(low, high), file=stats_file)
            for stat, x in last.items():
                print("using last of time series:", file=stats_file)
                print("stats on {}:".format(stat), file=stats_file)
                print("data: {}".format(x), file=stats_file)
                print("min:", file=stats_file)
                print(np.min(x), file=stats_file)
            ...
            for stat, x in peak.items():
                print("using peak of time series:", file=stats_file)
                print("stats on {}:".format(stat), file=stats_file)
                print("data: {}".format(x), file=stats_file)
                print("min:", file=stats_file)
                print(np.min(x), file=stats_file)
