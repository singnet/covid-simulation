...
class AddPolicy:
    def __init__(self, model, policy, day):
        self.switch = day
        self.policy = policy
        self.model = model
        self.state = 0
...
def setup_city_layout(model, population_size, num_districts=1):
    ...
    for d in range(num_districts):
        ...
        family_factory.factory(district_population)
